...
// -- Set source data for update/delete -------------- //
const setVal = (props) => {
...
<template>
  <div class="">
    ...
    <div v-if="userInfo" class="py-3 px-6">
      <div class="inner flex gap-12">
        <section class="w-1/3">
          <h3 class="text-2xl font-bold mb-2">
            <span v-if="val.mode === 'create'">New ToDo</span>
            <span v-if="val.mode === 'createSub'">New sub-ToDo</span>
            <span v-if="val.mode === 'update'">Edit ToDo</span>
            <span v-if="val.mode === 'updateSub'">Edit sub ToDo</span>
            form
          </h3>
          <form action="">
            <el-input v-model="val.title" placeholder="title"/>
            <el-input v-model="val.description" placeholder="descriptions"/>
        ...
        <section class="w-1/3">
          <h3 class="text-2xl font-bold mb-2">my todos</h3>
